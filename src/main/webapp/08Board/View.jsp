...
<form name="writeFrm">
	<input type="hidden" name="num" valude="<%= num %>" />
    <table border="1" width="90%">
        ...
        <tr>
            ...
            <!-- 엔터키로 처리된 부분을 <br>태그로 변경해야지만 줄바꿈돼 출력된다. -->
        ...
        <tr>
            <td colspan="4" align="center">    
           	<%
           	/*
           	로그인 됐고, 세션영역에 저장된 아이디가 해당 게시물을 작성한 아이디와 
           	일치한다면 수정, 삭제 버튼을 보이게 처리한다.
           	작성자 본인이 해당 게시물을 조회했을 때에 if문 안의 두개의 버튼이 보인다.
           	*/
