...
<head>
<meta charset="UTF-8">
<title>Covid19DataRead.jsp</title>
...
<script>
$(function(){
	//jQuery UI의 datepicker 선언. 한국에서 사용하는 날짜 포맷으로 변경.
	...
	//문서가 로드될 때 $.ajax()에서 사용할 기본적인 속성을 선언.
	$.ajaxSetup({
		url : "../Covid19DataRead.do",
		type : "get",
		contentType : "text/html;charset:utf-8;",
		dataType : "xml", //콜백 데이터의 타입
	});
