...
//시와 도를 select해서 List컬렉션으로 반환한다.
ArrayList<String> sidoList = dao.getSido();
//JSTL태그를 사용하기 위해 page영역에 저장한다.
...
<head>
<meta charset="UTF-8">
<title>DynamicAddress.jsp</title>
...
$(function(){
	...
	$('#sido').change(function(){
		$.ajax({
			...
			type : "get",
			contentType : "text/hrml;charset=UTF-8",
			...
			success : function(d){
				...
				//콜백 받은 JSON배열을 통해 each()메서드 실행
				$.each(d, function(index, data){
					console.log(index, data);
					//JSON배열의 크기만큼 option태그가 생성
