	...
	$('#goodsOptionId01').change(function(){
		$.ajax({
			...
			success : function(d){
				...
				//웹 브라우저에 총 금액을 출력한다.
				$('#priceDisplay').html("총 상품 금액: " + totalPrice);
