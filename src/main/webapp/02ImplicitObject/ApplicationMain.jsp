...
<body>
	...
	C:\02WorkspacePYM\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\K08JSPServlet\02ImplicitObject
	 -->
	<h2>서버의 물리적 경로 얻어오기</h2>
	application내장 객체 : <%= application.getRealPath("/02ImplicitObject") %>
	...
	내장 객체는 _jspService()메서드에서 생성된 지역변수이므로 더 넓은 지역인
	선언부에서 사용하려면 매개변수로 전달받아야 한다.
	
	this는 해당 application 자체.
	...
	*/
	...
	public String useImplicitObject(ServletContext app){
		/*
		방법2] 스크립트릿에서 메서드 호출시 application 내장 객체를
			매개변수로 전달해서 사용한다.
		*/
